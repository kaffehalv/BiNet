...
class ResNet():
    def __init__(self,
        ...
        self.filters_2 = int(shrink_factor * 32)
        self.repeats_2 = 6
        self.downsample_2 = True

        self.filters_3 = int(shrink_factor * 64)
        self.repeats_3 = 6
    ...
    def _conv_unit(self,
        ...
        sk = str(kernel_size) + "x" + str(kernel_size)
    ...
    def build(self, x):
        ...
        x = self._dense_block(
            x, units=self.classes, activation=self.activation, name="last")
